            ...
            Column(
              children: [
                  ...
                  child: Padding(
                      ...
                      child: RawAutocomplete<AutoCities>(
                          ...
                          optionsBuilder: (TextEditingValue textEditingValue) {
                            ...
                            return _itemsList
                                .where((AutoCities cities) => cities.name
                                    .toString()
                                    .toLowerCase()
                                    .startsWith(
                          ...
                          displayStringForOption: (AutoCities cities) =>
                              cities.name,
                          ...
                          optionsViewBuilder: (BuildContext context,
                              AutocompleteOnSelected<AutoCities> onSelected,
                              Iterable<AutoCities> options) {
                            return Align(
                ...
                GestureDetector(
                    ...
                    child: const Text(
                        "Not found your city in list? Manually add your city.",
                        style: TextStyle(
                            color: Colors.blue,
